...
in~\cite{bib:anonAnalysis}: the authors retrieved public available addresses from
...
Other related studies work on transaction profiling. In~\cite{bib:fullDiscl} is
