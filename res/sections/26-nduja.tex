...
\todo{explain difference between Account and Wallet Address throughout the paper}
...
having a local copy of the blockchain, that can counts hundreds of gigabytes~\cite{}\todo{Add citation for this assertion}. 
