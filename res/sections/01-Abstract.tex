...
binding wallet addresses to personal data of their owner. We exploit information publicly available on the web and the fact that users do not change their wallets at each transaction. In this way, it is not only possible to associate a person to a wallet but it is also possible to search for people that own multiple addresses, even if their are of different currencies.
\end{abstract}

% keywords
\begin{IEEEkeywords}
Blockchain, cryptocurrency, Bitcoin, Etherum, virtual currency
\end{IEEEkeywords}